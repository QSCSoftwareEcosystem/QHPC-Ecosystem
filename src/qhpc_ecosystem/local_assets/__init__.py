...
ASSETS = {
    ...
    "workflow-openqevo-nwqsim-tour": "workflows/openqevo-nwqsim-tour.yaml",
    ...
    "workflow-nwqsim-bell-simulation": "workflows/nwqsim-bell-simulation.yaml",
